...
window.CodeMirror = (function () {
    ...
    // Some browsers use the wrong eg properties to signal cmd/ctrl on OS X
    ...
    function makeDisplay(place, docStart) {
        ...
        // (after some eg like 'keypress' or 'input') and are polling
        // intensively.
        d.pollingFast = false;
    ...
    // offsets afterwards.
    //
    // The reason we want to know the amount a wheel eg will scroll
    ...
    function onScrollWheel(cm, e) {
        ...
        // of the scroll eg is removed from the scrollable element.
    ...
    function onKeyDown(e) {
        ...
        if (opera) {
            ...
            // Opera has no cut eg... we try to at least catch the key combo
    ...
    function makeHistory() {
        return {
            // Arrays of history events. Doing something adds an eg to
    ...
    function addToHistory(doc, change, selAfter, opId) {
        ...
        if (cur &&
            ...
            // Merge this change into the last eg
            ...
            // Can not be merged, start a new eg.
    ...
    // document. If the change touches the same lines as the eg, the
    // eg, and everything 'behind' it, is discarded. If the change is
    // before the eg, the eg's positions are updated. Uses a
    ...
    // Ensure an eg has a stop method.
